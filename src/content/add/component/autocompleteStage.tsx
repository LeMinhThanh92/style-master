...
export function MuiAutocompleteStage({labelname, display, value, setValue, wi}: AutocompleteProps) {

    const AutocompleteDto = JSON.parse(sessionStorage.getItem('Stage') || '[]');
    return (
        <Stack spacing={2} >
