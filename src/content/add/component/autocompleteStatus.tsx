...
export function MuiAutocompleteStatus({labelname, display, value, setValue, wi}: AutocompleteProps) {

    // const AutocompleteDto = JSON.parse(sessionStorage.getItem('Status') || '[]');
